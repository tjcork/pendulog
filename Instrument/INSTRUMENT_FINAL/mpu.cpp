...
#endif
    ret = dmp_enable_feature(DMP_FEATURE_6X_LP_QUAT | DMP_FEATURE_SEND_CAL_GYRO | DMP_FEATURE_SEND_RAW_ACCEL);
...
//gyro should be auto cal'd - hard code biases: -0.5725190639    -0.0305343508    -0.2290076255
  ...
  mympu.AX = ((float)accel[0] / ACC_SENS - 0.0261840820) * 1000.f;
  mympu.AY = ((float)accel[1] / ACC_SENS - 0.0240478515) * 1000.f;
  mympu.AZ = ((float)accel[2] / ACC_SENS - 0.0274658203) * 1000.f;
