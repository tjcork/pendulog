...
unsigned long sampleTimeout=1000/SAMPLE_FREQUENCY;
...
//  Serial.println("Calibration values: ");
  ...
  attachInterrupt(4, myinthandler, RISING);  // define interrupt for INT pin output of MPU9250
...
//  if(passThru)MahonyQuaternionUpdate(-ax, ay, az, gx*PI/180.0f, -gy*PI/180.0f, -gz*PI/180.0f,  my,  -mx, mz);
    ...
    if (delt_t > sampleTimeout) { // update LCD once per half-second independent of read rate
