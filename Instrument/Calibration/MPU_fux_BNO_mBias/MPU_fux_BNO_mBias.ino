...
//  display.display();
  ...
  {  
    ...
    Serial.println((float)(accelBias[0]),10); 
    Serial.println((float)(accelBias[1]),10); 
    Serial.println((float)(accelBias[2]),10); 
    
    Serial.print("mg");

    Serial.println(gyroBias[0], 10); 
    Serial.println(gyroBias[1], 10); 
    Serial.println(gyroBias[2], 10); 
    Serial.println("o/s"); 
    delay(1000); 
