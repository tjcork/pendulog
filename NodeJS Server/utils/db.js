...
exports.initialise = function () {
	state.pool.query('CREATE TABLE IF NOT EXISTS `data` (`ID` BIGINT UNSIGNED PRIMARY KEY,`TM` BIGINT UNSIGNED,`YW` DECIMAL(6,3),`PT` DECIMAL(6,3),`RL` DECIMAL(6,3),`AX` DECIMAL(6,3),`AY` DECIMAL(6,3),`AZ` DECIMAL(6,3),`QW` DECIMAL(6,3),`QX` DECIMAL(6,3),`QY` DECIMAL(6,3),`QZ` DECIMAL(6,3),`MX` DECIMAL(6,3),`MY` DECIMAL(6,3),`MZ` DECIMAL(6,3))', function (error, results, fields) {
	  if (error)
